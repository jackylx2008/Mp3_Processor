...
class ConvertTab(WorkflowTab):
    ...
    def __init__(self, parent: tk.Misc, **kwargs: Any) -> None:
        ...
        self.output_type = tk.StringVar(self, "mp3")
        ...
        self.extensions = {
            name: tk.BooleanVar(self, name in {"mp3", "m4a", "mp4", "wma"})
            for name in ("mp3", "m4a", "mp4", "wma", "wav", "flac", "ogg")
        }
        ...
        self.add_entry(1, "输出格式", self.output_type, values=("mp3", "m4a", "wma", "wav", "flac", "ogg"))
        ttk.Label(options, text="目标比特率").grid(row=1, column=2, sticky="e", padx=(24, 12))
        ttk.Combobox(
            options,
        ...
        ttk.Label(options, text="最大文件数 (0=无限制)").grid(row=1, column=4, sticky="e", padx=(24, 12))
    ...
    def collect_parameters(self) -> dict[str, object]:
        ...
        return {
            ...
            "output_type": self.required(self.output_type.get(), "输出格式"),
    ...
    def load_config(self, config: dict[str, Any], app_config: dict[str, Any]) -> None:
        ...
        self.output_type.set(config.get("output_type", "mp3"))
